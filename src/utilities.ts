...
export const justifyContent = (value: 'flex-start' | 'flex-end' | 'center' | 'space-between' | 'space-around' | 'space-evenly'): CSSProperties => ({
...
export const shadowMd = (): CSSProperties => ({ boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1)' });
export const shadowLg = (): CSSProperties => ({ boxShadow: '0 10px 15px -3px rgb(0 0 0 / 0.1), 0 4px 6px -4px rgb(0 0 0 / 0.1)' });
export const shadowXl = (): CSSProperties => ({ boxShadow: '0 20px 25px -5px rgb(0 0 0 / 0.1), 0 8px 10px -6px rgb(0 0 0 / 0.1)' });
...
// Cursor
export const cursor = (value: 'pointer' | 'default' | 'move' | 'not-allowed' | 'text' | 'wait' | 'grab' | 'grabbing'): CSSProperties => ({
  cursor: value,
});
...
// Transition
export const transition = (props: string = 'all', duration: number = 150, timing: string = 'ease-in-out'): CSSProperties => ({
...
export const rotate = (value: number | string): CSSProperties => ({ transform: `rotate(${typeof value === 'number' ? `${value}deg` : value})` });
export const scale = (value: number | string): CSSProperties => ({ transform: `scale(${value})` });
export const translateX = (value: number | string): CSSProperties => ({ transform: `translateX(${typeof value === 'number' ? `${value}px` : value})` });
export const translateY = (value: number | string): CSSProperties => ({ transform: `translateY(${typeof value === 'number' ? `${value}px` : value})` });
