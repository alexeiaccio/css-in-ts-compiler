...
export function createSizes(scale: number = DEFAULT_SCALE): SizeUtilities {
  ...
  return {
    ...
    roundedT: (value: number): CSSProperties => ({ borderTopLeftRadius: toScaleUnit(value), borderTopRightRadius: toScaleUnit(value) }),
    roundedB: (value: number): CSSProperties => ({ borderBottomLeftRadius: toScaleUnit(value), borderBottomRightRadius: toScaleUnit(value) }),
    roundedL: (value: number): CSSProperties => ({ borderTopLeftRadius: toScaleUnit(value), borderBottomLeftRadius: toScaleUnit(value) }),
    roundedR: (value: number): CSSProperties => ({ borderTopRightRadius: toScaleUnit(value), borderBottomRightRadius: toScaleUnit(value) }),
...
export function cx(...utilities: CSSProperties[]): string {
  ...
  const merged = utilities.reduce((acc, props) => ({
    ...acc,
    ...props,
  }), {} as CSSProperties);
