...
Open Questions
4. Slot naming - sv() or slots() for the function name?
5. Compound variants syntax - className vs class (css-variants uses className)?
6. Boolean variants - Should we support boolean shorthand? { primary: true } vs { primary: {} }
7. Responsive variants - Include from start or defer?
8. Default export - Should we export a default instance like cv or require named imports?
9. Dynamic props - How should dynamic() handle function props? (props) => value or just references?
