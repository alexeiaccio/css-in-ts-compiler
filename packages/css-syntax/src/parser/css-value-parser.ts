...
export class CSSValueParser {
  ...
  private parseFunctionWithName(name: string): FunctionNode | ColorFunctionNode | ColorMixNode | LightDarkNode {
    ...
    if (lowerName === "oklch" || lowerName === "oklab" || lowerName === "lab" || lowerName === "lch" ||
        lowerName === "hwb" || lowerName === "p3" || lowerName === "rec2020" || lowerName === "a98-rgb" ||
        lowerName === "prophoto-rgb" || lowerName === "xyz-d50" || lowerName === "xyz-d65" || lowerName === "xyz" ||
        lowerName === "srgb-linear" || lowerName === "srgb" || lowerName === "color") {
