 ...
 * ```
 */
export const parseValueDefEffect = (source: string): Effect.Effect<ReturnType<typeof parseValueDef>, CssParseError> =>
	Effect.try({
 ...
 * ```
 */
export const parseValueEffect = (source: string): Effect.Effect<ReturnType<CSSValueParser["parse"]>, CssParseError> =>
	Effect.try({
