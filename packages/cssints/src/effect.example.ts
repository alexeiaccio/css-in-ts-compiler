...
export const Globals = Schema.Union([
	Schema.TaggedStruct("inherit", { value: Schema.Literal("inherit") }),
	Schema.TaggedStruct("unset", { value: Schema.Literal("unset") }),
...
export const None = Schema.TaggedStruct("none", { value: Schema.Literal("none") });
export const Auto = Schema.TaggedStruct("auto", { value: Schema.Literal("auto") });

export const Finite = Schema.Union([Schema.Finite, Schema.TemplateLiteral([Schema.Finite])]);

class Dimension
	extends Schema.Opaque<Dimension>()(
		Schema.Struct({
	...
	implements CSS.Dimension {}

class Px extends Schema.Opaque<Px, { readonly brand: unique symbol }>()(
	Schema.Struct({
		value: Finite,
		ast: Dimension,
	}),
...
export function px(value: UnwrapValue<Px>): Px {
...
export const cn = (...fns: Px[]) =>
	runtime.runSync(
		Effect.gen(function* () {
			return yield* Effect.succeed(() => fns.map((fn) => generate(fn.ast)).join(" "));
		}),
	)();
