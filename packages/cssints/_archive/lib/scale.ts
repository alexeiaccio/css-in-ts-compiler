 ...
 */
export function scaleShorthand(v1: ScaleValue, v2?: ScaleValue, v3?: ScaleValue, v4?: ScaleValue): string {
...
export function createScaler(scale: number) {
	return {
		...
		scaleValues: (...values: ScaleValue[]) =>
			scaleValues(...values.map((v) => (typeof v === "number" ? v * scale : v))),
