 ...
 */
export function registerClass(property: string, value: string, className?: string): string {
 ...
 */
export function registerMultiPropertyClass(properties: Record<string, string>, className?: string): string {
 ...
 */
export function registerCSSProperty(name: string, syntax: string, inherits: boolean, initialValue: string): void {
 ...
 */
export function registerToken(token: TokenDefinition<unknown, string>): void {
	cssRegistry.tokens.set(token.name, token);

	// Also register as CSS @property
	registerCSSProperty(token.cssName, token.syntax, token.inherits, token.initialValue);
}
 ...
 */
export function transformPropertyCall(property: string, value: string): { className: string; css: string } {
 ...
 */
export function transformComposableCall(utilityName: string, args: string[]): { className: string; css: string } {
