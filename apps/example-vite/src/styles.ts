...
// Heading style
export const heading = cx(text(6), fontBold(), textCol(token("color.neutral.900")), md(text(8)), lg(text(10)));
...
export const responsivePadding = cx(p(2), sm(p(4)), md(p(6)), lg(p(8)));

// Example using parameter-based utilities
export const flexRowWrap = cx(flex(), alignItems("center"), justifyContent("center"));
